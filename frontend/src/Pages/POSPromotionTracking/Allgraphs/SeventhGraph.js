...
class SeventhGraphConfig extends Component {
    constructor(props) {
        super(props);
        this.state = {
            visitChartConfig: {
                ...
                dataSource: {
                    chart: {
                        "theme": "fusion",
                        "caption": "No of Tickets by Issue Date",
                        "rotateLabels": "0",
    ...
    componentWillMount() {
        ...
        visitChartConfig.dataSource.data = props.datasetSeventh
...
export default SeventhGraphConfig;
