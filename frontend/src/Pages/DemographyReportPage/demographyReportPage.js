...
class DemographyDomInt extends Component {
  ...
  getFilterValues = ($event) => {
    ...
    }, () => this.getDemographydropoutData())
  }

  getDemographydropoutData = () => {
    var self = this;
    let { endDate, startDate, regionSelected, countrySelected, citySelected, getCabinValue } = this.state;
    self.setState({ loading: true })

    apiServices.getDemographyReportData(endDate, startDate, regionSelected, countrySelected, citySelected, getCabinValue).then(function (result) {
