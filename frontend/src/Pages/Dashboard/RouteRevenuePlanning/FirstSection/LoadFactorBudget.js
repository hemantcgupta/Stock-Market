...
class LoadFactorBudget extends Component {
    constructor(props) {
        super();
        this.state = {
            loadFactorData: [],
    ...
    getGraphData(props) {
        ...
        apiServices.getLoadFactorBarChart(startDate, endDate, routeGroup, regionId, countryId, routeId, selectedTrend).then((loadFactorData) => {
        ...
        return (
            <div className="x_panel tile" style={{ paddingBottom: '15px' }}>
                <div className="x_title reduce-margin">
                    <h2 className='responsive-size'>LOAD FACTOR Budget</h2>
...
export default LoadFactorBudget;
