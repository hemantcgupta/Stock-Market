...
class TargetRational extends Component {
    ...
    componentWillReceiveProps = (props) => {
        ...
        apiServices.getTargetRationaltChart(startDate, endDate, regionId, countryId, cityId, commonOD).then((segmentationData) => {
        ...
        return (
            <div className="x_panel tile">
                <div className="x_title reduce-margin">
                    <h2 className='responsive-size'>Target Rational</h2>
                    <ul className="nav navbar-right panel_toolbox">
                        ...
                        <li onClick={() => this.props.history.push('/targetRational')}><i className="fa fa-line-chart"></i></li>
                    </ul>
                </div>
                {isLoading ?
                    <Spinners /> :
