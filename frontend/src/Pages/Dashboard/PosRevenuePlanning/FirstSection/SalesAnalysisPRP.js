...
class SalesAnalysisPRP extends Component {
    constructor(props) {
        super(props);
        this.state = {
            loading: false,
    ...
    getGraphData = (props) => {
        ...
        apiServices.getSalesAnalysisBudgetChart(a.join('-'), endDate, regionId, countryId, cityId, 'Day', selectedType, selectedGraph).then((salesAnalysisData) => {
        ...
        return (
            <div className="x_panel tile">
                <div className="x_title reduce-margin">
                    <h2 className='responsive-size'>Sales Analysis</h2>
...
export default SalesAnalysisPRP;