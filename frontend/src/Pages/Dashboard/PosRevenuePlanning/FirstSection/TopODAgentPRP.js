...
class TopODAgentPRP extends Component {
    constructor(props) {
        super();
        this.state = {
            topfiveODsData: [],
    ...
    getBarchartData = (props) => {
        ...
        if (self.state.headerName === 'TOP 10 AGENTS') {
            ...
            apiServices.getAgentsBudgetChart(startDate, endDate, regionId, countryId, cityId).then((topAgentsBarChart) => {
            ...
            apiServices.getODsBudgetChart(startDate, endDate, regionId, countryId, cityId).then((top5ODsBarChart) => {
