...
class ChannelWisePerform extends Component {
  ...
  componentWillReceiveProps = (props) => {
    ...
    apiServices.getChanneltable(startDate, endDate, regionId, countryId, cityId).then(function (result) {
...
export default ChannelWisePerform;