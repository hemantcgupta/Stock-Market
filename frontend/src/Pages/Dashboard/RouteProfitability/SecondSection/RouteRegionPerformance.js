...
class RouteRegionPerformance extends Component {
  ...
  componentWillReceiveProps = (props) => {
    ...
    apiServices.getRouteRegionPerformanceTable(startDate, endDate, routeGroup, regionId, countryId, routeId, typeofCost).then(function (result) {
    ...
    return (
      <div>
        <div className="x_title">
          ...
          <h2>Route Region Performance</h2>
...
export default RouteRegionPerformance;