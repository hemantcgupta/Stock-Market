...
class SurplusDeficit extends Component {
    constructor(props) {
        super();
        this.state = {
            revenueData: [],
    ...
    getGraphData(props) {
        ...
        apiServices.getSurplusDeficitBarChart(startDate, endDate, routeGroup, regionId, countryId, routeId, selectedTrend).then((revenueData) => {
        ...
        return (
            <div className="x_panel tile">
                <div className="x_title reduce-margin">
                    <h2 className='responsive-size'>Surplus/(Deficit)</h2>
